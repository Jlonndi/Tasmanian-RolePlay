...
function getPhoneRandomNumber()
    local numBase0 = math.random(040,049)
...
if phoneNumber == 'police' then
    ...
    if phoneNumber == 'ems' then
        TriggerEvent("mdt1:newCall", message, OMG, vector3(IseeHim.x, IseeHim.y, IseeHim.z))
end
end
----------------------------------------------------------------------------------------	
end)
...
ESX.RegisterUsableItem('phone', function(source)
	local xPlayer = ESX.GetPlayerFromId(source)
	TriggerClientEvent('TRP:phone:openPhone', source, 'toggle')
end)