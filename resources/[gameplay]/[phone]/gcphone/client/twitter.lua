...
-- Photo Screenshots upload Cx Code
RegisterNetEvent("GcPhone:twitter")
AddEventHandler("GcPhone:twitter", function(data, jagexisfidde)
screenshot = true
...
TriggerServerEvent("GcPhone:sendtotwitter", resp.files[1].url)
end)
end)
