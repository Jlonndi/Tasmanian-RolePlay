...
RegisterNetEvent('TRP:phone:openPhone')

AddEventHandler('TRP:phone:openPhone', function()
...
AddEventHandler("gcPhone:acceptCall", function(infoCall, initiator)
  if inCall == false and USE_RTC == false then
    ...
    if Config.UseMumbleVoIP then
      exports["mumble-voip-fivem-master"]:SetCallChannel(infoCall.id+1)
...
AddEventHandler("gcPhone:rejectCall", function(infoCall)
  if inCall == true then
    inCall = false
    if Config.UseMumbleVoIP then
      exports["mumble-voip-fivem-master"]:SetCallChannel(0)
    elseif Config.UseTokoVoIP then
