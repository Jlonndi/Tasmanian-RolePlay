...
$(function () {
	...
	viewTicket = new Vue({
		...
		methods: {
			...
			gotoTicket: function (event) {
				var targetid = $(event.target).attr('data-id');
				console.log(targetid);
				$.post('https://trp_admin/rep_panel', JSON.stringify({ id: targetid, type: 'goto' })); $(this).blur();
			},
			bringTicket: function (event) {
				var targetid = $(event.target).attr('data-id');
				console.log(targetid);
				$.post('https://trp_admin/bring_panel', JSON.stringify({ id: targetid, type: 'bring' })); $(this).blur();
			},
