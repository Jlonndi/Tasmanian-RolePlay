...
local clothing_shops = {
    {name="Clothing Store", id=73, x=1930.519, y=3731.839, z=32.87},
    {name="Clothing Store", id=73, x=1693.26, y=4822.27, z=42.1},
    {name="Clothing Store", id=73, x=125.83, y=-223.16, z=54.6},
    {name="Clothing Store", id=73, x=-710.16, y=-153.26, z=37.45},
    {name="Clothing Store", id=73, x=-821.69, y=-1073.90, z=11.33},
    {name="Clothing Store", id=73, x=-1192.81, y=-768.24, z=17.35},
    {name="Clothing Store", id=73, x=4.25, y=6512.88, z=31.93},
    {name="Clothing Store", id=73, x=425.471, y=-806.164, z=29.5},
    {name="Clothing Store", id=73, x=-1101.017, y=2710.264, z=19.15},
    {name="Clothing Store", id=73, x=1196.877, y=2709.760, z=38.27},
}
incircle = false
    ...
    while true do
        ...
        for k,v in ipairs(clothing_shops) do
            if(Vdist(pos.x, pos.y, pos.z, v.x, v.y, v.z) < 15.0)then
                DrawMarker(27, v.x, v.y, v.z - 1, 0, 0, 0, 0, 0, 0, 3.0001, 3.0001, 0.5001, 1555, 0, 0,165, 0, 0, 0,0)
                if(Vdist(pos.x, pos.y, pos.z, v.x, v.y, v.z) < 2.0)then
                    ...
                    if IsControlJustReleased(1, 51) then -- INPUT_CELLPHONE_DOWN
                        ...
                        menauXOption = 0.11 --------------------- X postiion of Menu.Option text                  
                ...
                elseif(Vdist(pos.x, pos.y, pos.z, v.x, v.y, v.z) > 3.0)then
                    ...
                    if clothing_menu then
                        save()
                        DisplayHelpText("~g~ Clothes Saved.")
                    end
                    clothing_menu = false
                end
            end
