...
ESX.RegisterServerCallback('trp_adminboard:getConnectedPlayers', function(source, cb)
	cb(connectedPlayers)
end)
...
AddEventHandler('esx:setJob', function(playerId, job, lastJob)
	...
	TriggerClientEvent('trp_adminboard:updateConnectedPlayers', -1, connectedPlayers)
end)
...
function AddPlayerToScoreboard(xPlayer, update)
	...
	if xPlayer.player.getGroup() == 'user' then
		Citizen.CreateThread(function()
			Citizen.Wait(3000)
			TriggerClientEvent('trp_adminboard:toggleID', playerId, false)
		end)
	end
end
...
function UpdatePing()
	...
	TriggerClientEvent('trp_adminboard:updatePing', -1, connectedPlayers)
end
...
TriggerEvent('es:addGroupCommand', 'sctoggle', 'admin', function(source, args, user)
	TriggerClientEvent('trp_adminboard:toggleID', source)
end, function(source, args, user)
	TriggerClientEvent('chat:addMessage', source, { args = { '^1SISTEMA', 'Non hai i permessi per farlo.' } })
