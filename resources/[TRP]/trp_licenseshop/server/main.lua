...
-- Buy Weapon License
RegisterServerEvent('esx_licenseshop:buyLicenseWeapon1')
AddEventHandler('esx_licenseshop:buyLicenseWeapon1', function()
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)

	if xPlayer.getInventoryItem('money').count >= 5000 then
		xPlayer.removeInventoryItem("money", 5000)
		TriggerClientEvent('esx:showNotification', _source, 'Firearms License Purchased $5000')
...
RegisterServerEvent('esx_licenseshop:buyPistolAmmo')
AddEventHandler('esx_licenseshop:buyPistolAmmo', function()
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)

	if xPlayer.getInventoryItem('money').count >= Config.AmmoPistol then
		xPlayer.removeInventoryItem("money", Config.AmmoPistol)
		TriggerClientEvent('esx:showNotification', _source, _U('Pistol_Ammo_Purchased'))
