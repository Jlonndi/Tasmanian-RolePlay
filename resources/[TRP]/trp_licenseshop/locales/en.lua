Locales['en'] = {
  ['buy_license'] = 'Weapon License & Ammo',
  ['press_access'] = 'press ~INPUT_CONTEXT~ to buy License & Ammo',
  ...
  ['Pistol_Ammo_Purchased'] = '1x Pistol Ammo Purchased',
  ['license_lmg'] = 'LMG License',
  ['ammo_weapon'] = 'Pistol Ammo',
