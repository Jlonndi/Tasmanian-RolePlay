...
TriggerEvent('chat:addSuggestion', '/shuff', 'Shuff Over')
    ...
    if distance~=-1 and distance<=3.0 then
        ESX.TriggerServerCallback("fn_cuff_item:isCuffed",function(cuffed)
            if not cuffed then
                ...
                exports['progressBars']:startUI(5000, 'you are cuffing suspect')
            else
...
AddEventHandler("fn_cuff_item:uncuff",function()
    ...
    if distance~=-1 and distance<=3.0 then
        ...
        exports['progressBars']:startUI(1000, 'you are un-cuffing suspect')
    else
        ESX.ShowNotification("~r~No players nearby")
    end
end)
...
RegisterNetEvent('fn_cuff_item:checkcuffs')
AddEventHandler('fn_cuff_item:checkcuffs', function()
	--if IsHandcuffed then 
	print('this is running')
    TriggerEvent('fn_cuff_item:forceUncuff') -- hacky I know lol
	--end
end)
...
AddEventHandler("fn_cuff_item:handcuff",function()
    ...
    Citizen.CreateThread(function()
        if IsHandcuffed then
            ...
            exports['progressBars']:startUI(5000, 'you are being cuffed')
			Citizen.Wait(5000)
...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        if not IsHandcuffed and not IsControlEnabled(0, 140) then EnableControlAction(0, 140, true) sleep = 500 end
    end
end)
...
plates = {
    {"plate01","https://cdn.discordapp.com/attachments/807254167155900436/807325120863141958/plate_01.png",936,337},
    {"plate01_n","https://cdn.discordapp.com/attachments/807254167155900436/807325123651829781/plate_01_NRML.png",936,337},
    {"plate02","https://cdn.discordapp.com/attachments/807254167155900436/807325120863141958/plate_01.png",936,337},
    {"plate02_n","https://cdn.discordapp.com/attachments/807254167155900436/807325123651829781/plate_01_NRML.png",936,337},
    {"plate03","https://cdn.discordapp.com/attachments/807254167155900436/807325120863141958/plate_01.png",936,337},
    {"plate03_n","https://cdn.discordapp.com/attachments/807254167155900436/807325123651829781/plate_01_NRML.png",936,337},
    {"plate04","https://cdn.discordapp.com/attachments/807254167155900436/807325120863141958/plate_01.png",936,337},
    {"plate04_n","https://cdn.discordapp.com/attachments/807254167155900436/807325123651829781/plate_01_NRML.png",936,337},
    {"plate05","https://cdn.discordapp.com/attachments/807254167155900436/807325120863141958/plate_01.png",936,337},
    {"plate05_n","https://cdn.discordapp.com/attachments/807254167155900436/807325123651829781/plate_01_NRML.png",936,337},
    {"yankton_plate","https://cdn.discordapp.com/attachments/807254167155900436/807329850574635008/yankton_plate.png",936,337},
    {"yankton_plate_n","https://cdn.discordapp.com/attachments/807254167155900436/807329833666609182/yankton_plate_NRML.png",936,337},
    }
				...
				if GetPedInVehicleSeat(veh, -1) == playerped then
					...
					if GetVehicleClass(veh) == 18 then
						...
						if not IsPauseMenuActive() then
							...
							-- TOG LX SIREN
							elseif IsDisabledControlJustReleased(0, 19) or IsDisabledControlJustReleased(0, 82) or IsDisabledControlJustReleased(0, 246) then
