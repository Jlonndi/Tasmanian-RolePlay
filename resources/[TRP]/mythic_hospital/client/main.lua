...
RegisterNetEvent('TRP:AMBULANCEJOB')
AddEventHandler('TRP:AMBULANCEJOB', function()
local player = PlayerPedId()
...
exports['mythic_notify']:SendAlert('inform', 'You\'ve been treated by a EMS.')

end)

RegisterNetEvent('TRP:AMBULANCEJOBHEAL')
AddEventHandler('TRP:AMBULANCEJOBHEAL', function()
local player = PlayerPedId()
SetEntityHealth(player, GetEntityMaxHealth(player))
ClearPedBloodDamage(player)
SetPlayerSprint(PlayerId(), true)
...
--TriggerEvent('mythic_hospital:client:ResetLimbs')
--TriggerEvent('esx_ambulancejob:revive')
exports['mythic_notify']:SendAlert('inform', 'You\'ve had a bandage applied over your wounds.')

end)

RegisterNetEvent('TRP:AMBULANCEJOBSPLINT')
AddEventHandler('TRP:AMBULANCEJOBSPLINT', function()
local player = PlayerPedId()
--SetEntityHealth(player, GetEntityMaxHealth(player))
ClearPedBloodDamage(player)
SetPlayerSprint(PlayerId(), true)
...
--TriggerEvent('esx_ambulancejob:revive')
exports['mythic_notify']:SendAlert('inform', 'You\'ve had a splint applied over your injury.')
