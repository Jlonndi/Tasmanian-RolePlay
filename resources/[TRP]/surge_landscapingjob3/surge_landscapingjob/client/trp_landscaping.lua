...
local landscaperXP = xp
                    if status3 ~= nil then -- workaround
                        ...
                        landscapingXP = xp
                        if landscapingXP <= 199 then
                            FindLocation(1)
                        elseif landscapingXP >= 200 and landscapingXP <= 399 then
                            FindLocation(2)
                        elseif landscapingXP >= 400 and landscapingXP <= 599 then
                            FindLocation(3)
                        elseif landscapingXP >= 600 then
                            FindLocation(4)
                        end
