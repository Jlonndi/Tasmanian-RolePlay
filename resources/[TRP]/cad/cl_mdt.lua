...
Citizen.CreateThread(function()
    while true do
        ...
        if not isVisible and IsPedInAnyPoliceVehicle(playerPed) and IsControlJustPressed(0, 344) and GetEntitySpeed(playerVeh) < 5.0 then
        ...
        elseif IsControlJustPressed(0, 344) and not IsPedInAnyPoliceVehicle(playerPed) then
            TriggerServerEvent("mdt:hotKeyOpen")
        end
