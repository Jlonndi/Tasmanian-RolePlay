...
function isEmergencyStaff()
    ...
    if ESX.PlayerData.job ~= nil and (ESX.PlayerData.job.name == 'police' or ESX.PlayerData.job.name == 'offpolice' or ESX.PlayerData.job.name == 'ambulance' or ESX.PlayerData.job.name == 'offambulance') then
        return true
...
AddEventHandler(
    ...
    function()
        ...
        if launderNPC ~= nil then
            ...
            if reaction == 1 then
                TaskReactAndFleePed(launderNPC, PlayerPedId())
