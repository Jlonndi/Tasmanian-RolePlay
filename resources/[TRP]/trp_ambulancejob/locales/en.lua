Locales['en'] = {
  ...
  ['medrestrain'] = 'Medical Restraints',
  ...
  ['TRP_SpawnEMSVehicle'] = 'Get Vehicle',
  ...
  ['go_down_pillboxlvl2'] = 'press ~INPUT_CONTEXT~ for The Ground Level.',
  ['go_up_pillboxgarage'] = 'press ~INPUT_CONTEXT~ for Level 2 Pillbox.',
  ['go_up_pillboxroof'] = 'press ~INPUT_CONTEXT~ for Roof Level Pillbox.',
  ...
  ['ems_menu_small'] = 'apply bandage over wounds',
  ['ems_menu_big'] = 'apply splint over injuries',
  -- Phone
  ...
  ['used_splint'] = 'You have used ~y~1x~s~ splint',
