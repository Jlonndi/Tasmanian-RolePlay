						...
						ESX.TriggerServerCallback('esx_ambulancejob:getItemAmount', function(quantity)
							if quantity > 0 then
								...
								if health > 0 then
									...
									TriggerServerEvent('esx_ambulancejob:removeItem', 'medikit1')
									TriggerServerEvent('esx_ambulancejob:splint', GetPlayerServerId(closestPlayer), 'big')
									ESX.ShowNotification(_U('heal_complete', GetPlayerName(closestPlayer)))
									IsBusy = false
								else
									ESX.ShowNotification(_U('player_not_conscious'))
								...
								ESX.ShowNotification(_U('not_enough_medikit1'))
							end
						end, 'medikit')
...
RegisterNetEvent('TRP:BandageItem')
AddEventHandler('TRP:BandageItem', function()
local closestPlayerPed = GetPlayerPed(closestPlayer)
local health = GetEntityHealth(closestPlayerPed)
...
function OpenVehicleSpawnerMenu(hospital, partNum)
	...
	--	{label = _U('garage_storeditem'), action = 'garage'},
		...
		{label = _U('TRP_SpawnEMSVehicle'), action = 'SpawnEMSVehicle'},
	}
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle', {
		...
		elseif data.current.action == 'SpawnEMSVehicle' then
			     OpenEMSVehicleSpawner()
				else
...
function OpenEMSVehicleSpawner()
print('Fidde')
...
function OpenPharmacyMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'pharmacy', {
		...
		elements = {
			...
			{label = _U('pharmacy_take', _U('splint')), value = 'medikit1'},
			{label = _U('pharmacy_take', _U('bandage')), value = 'bandage'},
			{label = _U('pharmacy_take', _U('medrestrain')), value = 'medicalrestraints'},
		}
	}, function(data, menu)
