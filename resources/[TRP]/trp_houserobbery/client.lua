...
AddEventHandler('houseRobberies:attempt', function(lockpicks)
 ...
 elseif not isNight() and not isRobbing then
  ...
  TriggerEvent('notification', 'It is too hot to hit this house maybe try again at night.', 2)
 else
...
---This is the function that spawns in the ped
 local airoll = math.random(5)
 if airoll == 1 then
  robberyped = CreatePed(GetPedType(modelhash), modelhash, generator.x+6.86376900,generator.y+1.20651200,generator.z+1.36589100, 30.0, 1, 1)
