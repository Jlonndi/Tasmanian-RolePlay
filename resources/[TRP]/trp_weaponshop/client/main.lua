                    ...
                    if Config.LicenseEnable and Config.Zones[CurrentActionData.zone].Legal then
                        ESX.TriggerServerCallback('esx_license:checkLicense', function(hasWeaponLicense)
                            if hasWeaponLicense then
                                ...
                                exports['mythic_notify']:SendAlert('inform', 'You do not have a Weapons license', 2500, { ['background-color'] = '#2f5c73', ['color'] = '#FFFFFF' })
                                    exports['mythic_notify']:SendAlert('inform', 'Buy Weapon licenses from the other counter', 2500, { ['background-color'] = '#2f5c73', ['color'] = '#FFFFFF' })
                            sleep = 500
                                end
