...
-------------------------------------------------------
Config = {
    VehDensity = 0.3, -- How many vehicles are driving (0.0 - 1.0) | The lower the number the less cars
    ...
    DispatchDead = false, -- Do you want AI to dispatch? True = No | False = Yes
    }
    --------------------------
    -- ^^^ DO THAT HERE ^^^ -- 
    --------------------------
