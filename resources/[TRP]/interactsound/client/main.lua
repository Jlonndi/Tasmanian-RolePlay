...
-- @TODO Change sound volume based on the distance the player is away from the playOnEntity.
------
RegisterNetEvent('InteractSound_CL:PlayWithinDistanceTRPOneSync')
AddEventHandler('InteractSound_CL:PlayWithinDistanceTRPOneSync', function(playerCoords, maxDistance, soundFile, soundVolume)
    local lCoords = GetEntityCoords(PlayerPedId())
