...
AddEventHandler('InteractSound_SV:PlayWithinDistance', function(maxDistance, soundFile, soundVolume)
    TriggerClientEvent('InteractSound_CL:PlayWithinDistanceTRPOneSync', -1, GetEntityCoords(GetPlayerPed(source)), maxDistance, soundFile, soundVolume) -- ONESYNC INFINITY AWARENESS
end)
