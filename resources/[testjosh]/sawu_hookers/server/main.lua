...
AddEventHandler('sawu_hookers:pay', function(boolean)
    ...
    if (boolean == true) then
        if xPlayer.getInventoryItem('money').count >= Config.BlowjobPrice then
            xPlayer.removeInventoryItem('money', Config.BlowjobPrice)
        ...
        if xPlayer.getInventoryItem('money').count >= Config.SexPrice then
            xPlayer.removeInventoryItem('money', Config.SexPrice)
