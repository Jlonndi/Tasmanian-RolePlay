        ...
        if(data.characters !== null) {
            $.each(data.characters, function (index, char) {
                if (char.charid !== 0) {
                    ...
                    $('[data-charid=' + charid + ']').html('<h3 class="character-fullname">'+ char.firstname +' '+ char.lastname +'</h3><div class="character-info"><p class="character-info-work"><strong>Job: </strong><span>'+ char.job +'</span></p><p class="character-info-bank"><strong>Bank balance: </strong><span>'+ char.bank + '$' +'</span></p> <p class="character-info-dateofbirth"><strong>Date of birth: </strong><span>'+ char.dateofbirth +'</span></p> <p class="character-info-gender"><strong>Gender: </strong><span>'+ char.sex +'</span></p> <p class="character-info-height"><strong>Heigh: </strong><span>'+ char.height + 'cm' +'</span></p> <p class="character-info-phone-number"><strong>Phone number: </strong><span>'+ char.phone_number   +'</span></p> <p class="character-info-phone-number"><strong>Dead: </strong><span>'+ char.is_dead   +'</span></p></div>').attr("data-ischar", "true");
                }
            });
        }
    };
