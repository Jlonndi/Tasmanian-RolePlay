...
local justTheTip = false



AddEventHandler('playerSpawned', function()

    if not justTheTip then
        ...
        if ESX.PlayerData.lastPosition ~= nil then
            ...
            SetEntityCoords(playerPed, ESX.PlayerData.lastPosition.x, ESX.PlayerData.lastPosition.y, ESX.PlayerData.lastPosition.z + 0.25)
...
RegisterNetEvent('esx:spawnVehicleAdmin')

AddEventHandler('esx:spawnVehicleAdmin', function(model, reason)
...
AddEventHandler('esx:deleteVehicle', function(type)

	local playerPed = PlayerPedId()

	local vehicle   = ESX.Game.GetVehicleInDirection()

	local entity 	= ESX.Game.GetVehicleInDirection()
	local vehicleProps = ESX.Game.GetVehicleProperties(vehicle)
	TriggerEvent('persistent-vehicles/forget-vehicle', vehicle) -- cocks forces it out of persistent allow for DV
    ...
    if type ~= nil then
	 ...
	 print('fidde')
	 TriggerServerEvent('TRP:IMPOUNDSTATE', vehicleProps.plate) -- force impounds vehicle
    end
	TriggerServerEvent('TRP:IMPOUNDSTATE', vehicleProps.plate)
...
AddEventHandler("esx:toggleUI2", function()
...
AddEventHandler("esx:toggleMap", function()
...
RegisterNetEvent('esx:updateCharacter')

AddEventHandler('esx:updateCharacter', function(xPlayer)
