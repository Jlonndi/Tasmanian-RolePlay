...
RegisterNetEvent("trp_inventoryhud:openGloveboxInventory")
AddEventHandler(
    "trp_inventoryhud:openGloveboxInventory",
...
RegisterNetEvent("trp_inventoryhud:refreshGloveboxInventory")
AddEventHandler(
    "trp_inventoryhud:refreshGloveboxInventory",
    function(data, blackMoney, cashMoney, inventory, weapons)
        setGloveboxInventoryData(data, blackMoney, cashMoney, inventory, weapons)
    end
)
