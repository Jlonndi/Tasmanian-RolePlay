...
function OpenShopInv(shoptype)
    ...
    Citizen.Wait(500)
    TriggerEvent("trp_inventoryhud:openShopInventory", data, inventory)
end
...
RegisterNetEvent("trp_inventoryhud:openShopInventory")
AddEventHandler("trp_inventoryhud:openShopInventory", function(data, inventory)
