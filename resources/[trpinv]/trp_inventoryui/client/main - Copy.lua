...
AddEventHandler("onResourceStop", function(resource) -- Force Hide Menu On Restart
...
AddEventHandler('esx:playerLoaded', function(xPlayer)
    ...
    ESX.TriggerServerCallback("trp:core:getNames", function(jewsdidnothingwrong)
...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        if IsDisabledControlJustReleased(0, Config.OpenControl) and IsInputDisabled(0) then
            ...
            TriggerServerEvent('trp-core:inventoryopen', 'Inventory') -- log hotkey open catch spammers ?
		...
		if IsDisabledControlJustReleased(0, 159) then
          ...
          if IsInputDisabled(0) and not IsDead then
            ...
            TriggerEvent('esx_inventoryhud:hotbarEquipt', 6)
		...
		if IsDisabledControlJustReleased(0, 161) then
          ...
          if IsInputDisabled(0) and not IsDead then
            ...
            TriggerEvent('esx_inventoryhud:hotbarEquipt', 7)
		...
		if IsDisabledControlJustReleased(0, 162) then
          ...
          if IsInputDisabled(0) and not IsDead then
            ...
            TriggerEvent('esx_inventoryhud:hotbarEquipt', 8)
		...
		if IsDisabledControlJustReleased(0, 163) then
          ...
          if IsInputDisabled(0) and not IsDead then
            ...
            TriggerEvent('esx_inventoryhud:hotbarEquipt', 9)
...
function openInventory()
    ...
    if not hudToggled then
        ...
        TriggerEvent('trp:core:toggleHud')
...
function useItem(item, inInventory)
  ...
  if inInventory then
    ...
    if shouldCloseInventory(item) then
      ...
      Citizen.Wait(250)
      --TriggerServerEvent('trp-Inventory:USEGayCunts','item invalid or not in inventory')
      loadPlayerInventory()
