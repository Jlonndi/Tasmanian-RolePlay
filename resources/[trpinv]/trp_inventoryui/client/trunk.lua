...
RegisterNetEvent("trp_inventoryhud:openTrunkInventory")

AddEventHandler("trp_inventoryhud:openTrunkInventory", function(data, blackMoney, inventory, weapons)
...
RegisterNetEvent("trp_inventoryhud:refreshTrunkInventory")

AddEventHandler("trp_inventoryhud:refreshTrunkInventory", function(data, blackMoney, inventory, weapons)
...
function setTrunkInventoryData(data, blackMoney, inventory, weapons)
    ...
    print("TRP-CORE: ", data, blackMoney, ESX.DumpTable(inventory), ESX.DumpTable(weapons))
