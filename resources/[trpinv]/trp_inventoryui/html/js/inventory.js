...
window.addEventListener("message", function (event) {
    ...
    if (event.data.action == "display") {
        ...
        $.post("http://trp_inventoryui/sendItemInSlot", JSON.stringify({
        ...
        $(".nearbyPlayerButton").click(function () {
            ...
            $.post("http://trp_inventoryui/GiveItem", JSON.stringify({
...
function closeInventory() {
    ...
    $.post("http://trp_inventoryui/NUIFocusOff", JSON.stringify({}));
...
$(document).on('dblclick', '.item', function() {
  ...
  if (itemData.usable) {
    ...
    $.post("http://trp_inventoryui/UseItem", JSON.stringify({
...
$(document).on('click', '#give', function() {
...

 {
      ...
      $.post("http://trp_inventoryui/GetNearPlayers", JSON.stringify({
...
$(document).on('click', '#drop', function() {
  ...
  if (itemInventory == undefined || itemInventory == "second") {
...

   {
      ...
      $.post("http://trp_inventoryui/DropItem", JSON.stringify({
    ...
    $('#playerInventory').droppable({
        ...
        drop: function (event, ui) {
            ...
            if (type === "trunk" && itemInventory === "second") {
                ...
                $.post("http://trp_inventoryui/TakeFromTrunk", JSON.stringify({
                ...
                $.post("http://trp_inventoryui/TakeFromProperty", JSON.stringify({
                ...
                $.post("http://trp_inventoryui/TakeFromPlayer", JSON.stringify({
    ...
    $('#otherInventory').droppable({
        ...
        drop: function (event, ui) {
            ...
            if (type === "trunk" && itemInventory === "main") {
                ...
                $.post("http://trp_inventoryui/PutIntoTrunk", JSON.stringify({
                ...
                $.post("http://trp_inventoryui/PutIntoProperty", JSON.stringify({
                ...
                $.post("http://trp_inventoryui/PutIntoPlayer", JSON.stringify({
