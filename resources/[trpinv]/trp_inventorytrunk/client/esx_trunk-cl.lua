...
function OpenPropertyMenu(plate, max, myVeh)
  ...
  --[[print('function run', plate)
	...
	ESX.TriggerServerCallback("trp:core:getPropertyData", function(inventory)
		...
		TriggerEvent("trp_inventoryhud:openTrunkInventory", data, items.black_money[1].amount, items.coffre, items.weapons)
	...
	ESX.TriggerServerCallback("esx_trunk:getInventoryV", function(inventory)
		...
		TriggerEvent("trp_inventoryhud:openTrunkInventory", data, inventory.blackMoney, inventory.items, inventory.weapons)
