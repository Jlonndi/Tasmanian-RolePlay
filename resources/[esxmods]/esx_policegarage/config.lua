...
--Police Car Garage:
Config.Marker = {
    {id = 108, x = 454.1275, y = -1017.719, z = 28.43738},
	{id = 108, x = 1868.268, y = 3694.154, z = 33.62708},
	{id = 108, x = -475.1736, y = 6017.473, z = 31.33557}
}
Config.Marker2 = {
   {id = 277, x = 448.6286, y = -981.6791, z = 43.6864},
}
...
Config.BoatDraw3DText = "Press [E] for EMS Garage~s~"		-- set your desired text here
...
Config.PoliceVehicles = {
	{ model = 'police', label = 'Police XR8', price = 0 },
	{ model = 'fbi2', label = 'Police Tahoe', price = 0 },
	{ model = 'policeve', label = 'Police Holden VE', price = 0 },
	{ model = 'policesub', label = 'Police Subaru WRX', price = 0 },
	{ model = 'mcc', label = 'Police Mobile Command Centre', price = 0 },
	{ model = '17gt500', label = 'Police Ford GT500 Mustang Unmarked', price = 0 },
	{ model = 'M5RB_VV', label = 'Police BMW M5 Unmarked', price = 0 },
	{ model = 'pdgts', label = 'Police Holden VF GTS Unmarked', price = 0 },
	{ model = 'hcat', label = 'Police Dodge Hellcat Unmarked', price = 0 },
	{ model = '16bugatti', label = 'Police Bugatti Chiron Unmarked', price = 0 },
	{ model = 'NS150', label = 'Police Raptor', price = 0 },
	{ model = 'pd_supra', label = 'Police Toyota Supra', price = 0 },
	{ model = 'ROVER', label = 'Police Range Rover', price = 0 },
	{ model = 'browardfpiu', label = 'Police Explorer', price = 0 },
	{ model = 'r1200rtp', label = 'Police Bike', price = 0 },
	{ model = 'pdevoke', label = 'Police Evoke', price = 0 },
	{ model = 'pdwagon', label = 'Police Wagon', price = 0 },
	{ model = 'mcraptor', label = 'Police Raptor Unmarked', price = 0 },
	{ model = 'chryslernonels', label = 'Police 300C Unmarked', price = 0 },
	{ model = 'nonelsm5', label = 'Police BMW M5', price = 0 },
	{ model = 'pdterritory', label = 'Police Territory', price = 0 },
	{ model = 'leostang', label = 'Police 1965 Mustang Unmarked', price = 0 },
	{ model = 'ABSHEL', label = 'Police Mustang Unmarked', price = 0 },
}

-- Police Helicopters:
Config.PoliceHelicopters = {
	{ model = 'swift2', label = 'Tasmanian Police MH-65', livery = 0, price = 0 }
}

-- Police Boats:
Config.PoliceBoats = {
	{ model = 'ambulance', label = 'Ambulance', livery = 0, price = 0 }
}
