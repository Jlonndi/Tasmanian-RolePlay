...
AddEventHandler('esx_taxijob:success', function()
  ...
  if societyAccount ~= nil then
    ...
    local playerMoney  = math.floor(total / 1000 * 30)
    local societyMoney = math.floor(total / 1000 * 70)

    xPlayer.addInventoryitem('money', playerMoney)
    ...
    xPlayer.addInventoryItem('money', total)
