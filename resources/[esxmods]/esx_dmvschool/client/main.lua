...
function StartDriveTest(type)
  TriggerServerEvent('esx_dmvschool:pay', Config.Prices[type], type) -- rework this shit
end


RegisterNetEvent('esx_dmvschool:startdrivetest1paid') -- checks if paid then runs event much safer
AddEventHandler('esx_dmvschool:startdrivetest1paid', function()
...
RegisterNetEvent('esx_dmvschool:startdrivetestpaid') -- checks if paid then runs event much safer
AddEventHandler('esx_dmvschool:startdrivetestpaid', function(type)
