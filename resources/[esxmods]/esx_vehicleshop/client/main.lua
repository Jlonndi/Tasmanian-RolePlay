...
RegisterNetEvent('trp-core:PDMLOGS')
AddEventHandler('trp-core:PDMLOGS', function(vehicleModel, Price)
	TriggerServerEvent('trp-core:PDMLOGS', vehicleModel, Price)
end)
RegisterNetEvent('trp-core:PDMLOGS1')
AddEventHandler('trp-core:PDMLOGS1', function(plate)
	TriggerServerEvent('trp-core:PDMLOGS1', plate)
end)
...
function OpenShopMenu()
	...
	SetEntityCoords(playerPed, Config.Zones.ShopInsideBUY.Pos)
...
function OpenBossActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'reseller',{
		...
		if data.current.value == 'boss_actions' then
			TriggerEvent('esx_society:openBossMenu', 'pdm', function(data2, menu2)
				menu2.close()
			end)
...
AddEventHandler('esx_vehicleshop:hasEnteredMarker', function(zone)
	...
	elseif zone == 'BossActions' and Config.EnablePlayerManagement and ESX.PlayerData.job ~= nil and ESX.PlayerData.job.name == 'pdm' and ESX.PlayerData.job.grade_name == 'boss' then
