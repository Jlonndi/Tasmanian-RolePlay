...
Config.CarZones = {
	PoliceCarGarage = {
		Pos = {
			...
			--vector3(325.1077, -575.9736, 28.79126)
			{x = 325.1077, y = -575.9736, z = 28.79126}
		}
	}
}
...
Config.CarGarageName = "EMS Garage"
...
Config.PoliceHelicopters = {
	{ model = 'hems', label = 'Tasmanian HEMS MH-65', livery = 0, price = 0 }
}
...
Config.TitlePoliceGarage = "EMS Garage"
