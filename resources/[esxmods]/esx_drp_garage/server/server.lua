...
ESX.RegisterServerCallback('eden_garage:checkMoney', function(source, cb, item, count)
    local xPlayer = ESX.GetPlayerFromId(source)

   if xPlayer.getInventoryItem('money').count >= item then
    print(item)
       -- 
...
-- End funds check
-- Withdraw money
AddEventHandler('eden_garage:pay', function(item, source, count)
    local xPlayer = ESX.GetPlayerFromId(source)
