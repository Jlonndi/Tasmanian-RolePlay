...
Config.Garages = {
	...
	Garage_Centre = {	
		Pos = {x = 222.2769, y = -792.6989, z = 29.727},
		Color = {r = 204, g = 204, b = 0},
		Size  = {x = 3.0, y = 3.0, z = 1.0},
		Marker = 1,
		
		SpawnPoint = {
			Pos = {x = 226.4286, y = -794.2418, z = 29.5722},
			Color = {r = 0, g = 255, b = 0},
			Size = {x = 3.0, y = 3.0, z = 1.0},
			Marker = 1,
			Heading = 157.84
		...
		DeletePoint = {
			Pos = {x = 220.3385, y = -791.8945, z = 29.646},
	...
	Garage_Paleto = {	
		Pos = {x=  -23.419782, y = 6398.586, z = 31.3973},
		Color = {r = 204, g = 204, b = 0},
		Size  = {x = 3.0, y = 3.0, z = 1.0},
		Marker = 1,
		
		SpawnPoint = {
			Pos = {x = -23.419782, y = 6398.809, z = 31.48718 - 1},
			Color = {r = 0, g = 255, b = 0},
			Size  = {x = 3.0, y = 3.0, z = 1.0},
			Marker = 1
		},
		DeletePoint = {
			Pos = {x = -29.85494, y = 6404.624, z = 31.48718 - 1 },
			Color = {r = 255, g = 0, b = 0},
			Size  = {x = 3.0, y = 3.0, z = 1.0},
			Marker = 1
		},
		--vector3(-29.85494, 6404.624, 31.48718)
		MunicipalPoundPoint = {
