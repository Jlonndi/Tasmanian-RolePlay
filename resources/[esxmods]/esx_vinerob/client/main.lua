...
function PoliceRobberyAlert()
    ...
    ESX.ShowAdvancedNotification('911 Call.', 'Burglary', 'Someone is breaking into a house. I attached a picture of the person.', mugshotStr, 1)
