...
AddEventHandler('esx_policejob:confiscatePlayerItem', function(target, itemType, itemName, amount)
	...
	if itemType == 'item_standard' then
		...
		if targetItem.count > 0 and targetItem.count <= amount then
			...
			if targetItem.count > -1 and (sourceItem.count + amount) > sourceItem.limit then
	...
	elseif itemType == 'item_account' then
		targetXPlayer.removeInventoryItem('money', amount)
		sourceXPlayer.addInventoryItem('money', amount)
...
AddEventHandler('esx_policejob:OutVehicle', function(target)
	...
	else if xPlayer.job.name == 'ambulance' then
		TriggerClientEvent('esx_policejob:OutVehicle', target)
	else
...
AddEventHandler('playerDropped', function()
	...
	if _source ~= nil then
		local xPlayer = ESX.GetPlayerFromId(_source)
local player = xPlayer.identifer
