...
Citizen.CreateThread(function()
	...
	while true do
		...
		if ESX.job ~= nil and ESX.job.name ~= 'police' then
...
function checkCar(car)
	...
	if car then
		...
		if isBlacked(carModel) then
            Citizen.Wait(300)
            exports['mythic_notify']:SendAlert('error', 'You Must Be A Police Officer to Drive this.', 8000, { ['background-color'] = '#ffffff', ['color'] = '#000000' })
